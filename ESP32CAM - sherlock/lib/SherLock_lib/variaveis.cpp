...
unsigned long duration = 0;                      // Duração do Pulso do Sensor
float distance = 0.0;                            // Distância calculada do Sensor
...
uint8_t contadorSendKPALV = 0;                   // Contador para enviar kpalv
